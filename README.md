...
* **Modules:**
  ...
  * **Audit Logs:** System-wide security logs detailing *who*, *when*, and *what* was done.
...
* **Modules:**
  ...
  * *Note: Once submitted, records are read-only for church leaders. They cannot modify or approve submissions.*
...
---
*Developed for MAINPI (Minister's Association Integrated Nutrition Program Inc.)*
